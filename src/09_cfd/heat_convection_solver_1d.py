...
def plot_solution(
    ...
    plt.ylabel("φ (Transported Scalar)", fontsize=12)
...
def main():
    ...
    print(f"Diffusion coefficient: Γ = {Gamma} kg/m·s")
    print(f"Peclet number: Pe = {Pe:.2f}")
    print(f"Cell Peclet number: Pe_cell = {Pe_cell:.4f}")
    print(f"Scheme: {scheme_name}")
    print("-" * 65)
    print(f"Left BC: φ(0) = {phi_0}")
    print(f"Right BC: φ(L) = {phi_L}")
    print("-" * 65)
